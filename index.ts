...
class Student {
  ...
  updateDetails(newName: string, newAge: number, newGrade: string) {
    this.name = newName;
    this.age = newAge;
    this.grade = newGrade;
  }
...
class StudentManagement {
  ...
  addStudent(name: string, age: number, grade: string) {
    const student = new Student(name, age, grade);
    this.students.push(student);
    console.log(`Added student: ${name}`);
  }

  updateStudent(name: string, newName: string, newAge: number, newGrade: string) {
